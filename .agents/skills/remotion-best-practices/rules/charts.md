...
You can create bar charts in Remotion by using regular React code - HTML and SVG
is allowed, as well as D3.js.
...
See [Bar Chart Example](assets/charts/bar-chart.tsx) for a basic example
implmentation.
