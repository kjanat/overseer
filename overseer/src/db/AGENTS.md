...
SQLite persistence with foreign key enforcement, CASCADE deletes, prefixed ID
constraints.
...
- `get_all_descendants()`: Recursive collection of all descendants (used for
  milestone bookmark cleanup)
