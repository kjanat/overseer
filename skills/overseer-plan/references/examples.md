...
const subtasks = [
	{
		desc: 'Create database schema for users/tokens',
		done: 'Migration runs, tables exist with FK constraints',
	},
	{
		desc: 'Implement auth controller with endpoints',
		done: 'POST /register, /login return expected responses',
	},
	{
		desc: 'Add JWT middleware for route protection',
		done: 'Unauthorized requests return 401, valid tokens pass',
	},
	{
		desc: 'Build frontend login/register forms',
		done: 'Forms render, submit without errors',
	},
	{
		desc: 'Add integration tests',
		done: '`npm test` passes with auth coverage',
	},
];
...
const phases = [
	...
	},
	{
		...
		items: [
			{
				desc: 'Login/register forms',
				done: 'Forms render, submit successfully',
			},
			{
				desc: 'Protected routes',
				done: 'Redirect to login when unauthenticated',
			},
			{
				desc: 'Session persistence',
				done: 'Refresh maintains logged-in state',
			},
		],
	},
];
