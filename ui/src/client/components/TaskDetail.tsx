...
import type { Learning, Priority, TaskId, TaskWithContext } from '../../types.js';
...
import { Dialog, DialogBody, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from './ui/Dialog.js';
							...
							? (
								<div className='space-y-1'>
									<EditField
										...
										saving={updateTask.isPending}
									/>
									{editError && <p className='font-mono text-xs text-status-blocked'>{editError}</p>}
								</div>
							)
							: (
								<button
